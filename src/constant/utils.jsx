...
export function areCropsEqual(cropA, cropB) {
  return (
...
export const centerCrop = (crop, containerWidth, containerHeight) => {
  const pixelCrop = convertToPixelCrop(crop, containerWidth, containerHeight);
...
export const convertToPercentCrop = (crop, containerWidth, containerHeight) => {
  if (crop.unit === "%") {
...
export const convertToPixelCrop = (crop, containerWidth, containerHeight) => {
  if (!crop.unit) {
...
export function nudgeCrop(pixelCrop, key, offset, ord) {
